...
/** @type {string} */
const CACHE_VERSION = '1735480488|3054693232';
/** @type {string} */
const CACHE_PREFIX = 'Cluck and Bawk-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Cluck.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Cluck.html","Cluck.js","Cluck.offline.html","Cluck.icon.png","Cluck.apple-touch-icon.png","Cluck.worker.js","Cluck.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Cluck.wasm","Cluck.pck","Cluck.side.wasm"];
